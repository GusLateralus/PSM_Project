...
dref=pd.get_dummies(datos_referencia['transtorno'],prefix='transtorno')
...
datos_referencia8=datos_referencia.drop(['transtorno'],axis=1)
...
print(dref.columns)  # Para ver los nombres exactos de las columnas
dref.columns = dref.columns.str.replace(' ', '_')

y_train = dref[['transtorno_Apnea', 'transtorno_Insomnio_Intermedio',
                'transtorno_Paralisis_del_Sueno', 'transtorno_Sin_Trastorno',
                'transtorno_Sindrome_de_Piernas_Inquietas']]
