...
modelo.add(tf.keras.layers.Dense(64, input_dim=7, activation='relu'))  # 4 características de entrada
...
# Entrenar el modelo
epocas  = modelo.fit(X_train, Y_train, epochs=10)
