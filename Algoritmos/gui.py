...
def ejecutar_codigo():
    ...
    def captura_video():    
        ...
        ########################### Supongamos que `EARI` es el indicador del estado de los ojos, actualizado en cada iteración.
                                ...
                                distancia_referencia=entry_distancia.get() 
        ...
        ####################################################################################################################################
                                ...
                                cv2.putText(frame, 'RI ' + str(y_rodilla_der), (250, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 3)
                                cv2.putText(frame, 'RD ' + str(y_rodilla_izq), (250, 60), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 3)
    ...
    # Crear y ejecutar el hilo para captura de video
    hilo_captura = threading.Thread(target=captura_video)
    hilo_captura.daemon = True  # Hilo de fondo, se cierra cuando se cierra la ventana principal
    hilo_captura.start()
